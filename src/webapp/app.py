"""FastAPI entry point for the browser-based hand pose game."""
...
class PredictRequest(BaseModel):
    image: str = Field(..., description="Base64 image data or a data URL.")
    threshold: float | None = Field(None, gt=0.0)


service = HandPoseService.from_environment()

app = FastAPI(
    title="Hand Pose T-Rex Web App",
    version="0.1.0",
    description="Webcam hand-pose inference connected to a browser runner game.",
)
