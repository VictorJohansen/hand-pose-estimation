...
Run from the project root:
    python -m src.training.train_baseline --epochs 30 --batch-size 32
"""
...
from src.models.baseline_cnn import DEFAULT_INPUT_SHAPE, build_baseline_cnn
...
def main() -> None:
    ...
    logging.info("Building baseline CNN...")
    model = build_baseline_cnn(input_shape=DEFAULT_INPUT_SHAPE)
    model.compile(
